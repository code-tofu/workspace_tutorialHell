...
public class SurveyResource {
	...
	public ResponseEntity<Object> addNewSurveyQuestion(@PathVariable String surveyId,
		...
		//returning "created" is response 201 and also returning the location where did resource is created i.e. ID
	...
	public ResponseEntity<Object> deleteSurveyQuestion(@PathVariable String surveyId,
		...
		//no-content indicates that the resource is deleted correctly
